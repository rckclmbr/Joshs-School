...
void CDragonEnemy::OnCollision(CObject *collisionObject)
{
...
void CDragonEnemy::Load()
{
	// load model
	CMD2Model::Load("models\\Dragon\\tris.md2", "models\\Dragon\\dragro3.pcx");

}

void CDragonEnemy::OnProcessAI()
{
